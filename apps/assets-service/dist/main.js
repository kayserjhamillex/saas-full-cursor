...
const service_exception_filter_1 = require("./shared/filters/service-exception.filter");
...
async function bootstrap() {
    ...
    app.useGlobalFilters(new service_exception_filter_1.ServiceExceptionFilter(serviceName));
