    ...
    <div class="page-wrap">
      <section class="page-card">
        <header class="page-card__header">
          <span class="page-card__eyebrow">Rendimiento</span>
          <h3 class="page-card__title">Metricas</h3>
        </header>
        <div class="page-card__body">
          <p class="page-card__lead">Visualizacion resumida de rendimiento, uso y conversion comercial.</p>
          <ul class="page-card__list">
            <li>Uso por modulo</li>
            <li>Crecimiento semanal</li>
            <li>Salud del sistema</li>
          </ul>
        </div>
