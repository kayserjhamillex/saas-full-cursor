    ...
    <div class="page-wrap">
      <section class="page-card">
        <header class="page-card__header">
          <span class="page-card__eyebrow">Configuracion</span>
          <h3 class="page-card__title">Modulos</h3>
        </header>
        <div class="page-card__body">
          <p class="page-card__lead">Administracion de activaciones por tenant segun contrato y plan.</p>
          <ul class="page-card__list">
            <li>Estado por modulo</li>
            <li>Activacion y desactivacion</li>
            <li>Dependencias funcionales</li>
          </ul>
        </div>
