    ...
    <div class="page-wrap">
      <section class="page-card">
        <header class="page-card__header">
          <span class="page-card__eyebrow">Inteligencia artificial</span>
          <h3 class="page-card__title">IA y analitica</h3>
        </header>
        <div class="page-card__body">
          <p class="page-card__lead">Control central de resultados IA y monitoreo de calidad de procesamiento.</p>
          <ul class="page-card__list">
            <li>Volumen de imagenes procesadas por tenant</li>
            <li>Tiempos de respuesta del AI service</li>
            <li>Hallazgos de alto riesgo para seguimiento</li>
          </ul>
        </div>
