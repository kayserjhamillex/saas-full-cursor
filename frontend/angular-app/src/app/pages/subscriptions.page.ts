    ...
    <div class="page-wrap">
      <section class="page-card">
        <header class="page-card__header">
          <span class="page-card__eyebrow">Facturacion recurrente</span>
          <h3 class="page-card__title">Suscripciones</h3>
        </header>
        <div class="page-card__body">
          <p class="page-card__lead">Seguimiento de planes, vigencias y renovaciones de cada tenant.</p>
          <ul class="page-card__list">
            <li>Planes activos por tenant</li>
            <li>Vencimientos proximos</li>
