    ...
    <div class="page-wrap">
      <section class="page-card">
        <header class="page-card__header">
          <span class="page-card__eyebrow">Administracion</span>
          <h3 class="page-card__title">Tenants</h3>
        </header>
        <div class="page-card__body">
          <p class="page-card__lead">Gestion de altas, estado comercial y configuracion inicial de cuentas.</p>
          <ul class="page-card__list">
            <li>Listado de tenants</li>
            <li>Activacion y suspension</li>
            <li>Segmentacion por plan</li>
          </ul>
        </div>
