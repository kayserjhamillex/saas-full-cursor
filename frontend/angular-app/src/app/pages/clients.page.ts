    ...
    <div class="page-wrap">
      <section class="page-card">
        <header class="page-card__header">
          <span class="page-card__eyebrow">Gestion de cuentas</span>
          <h3 class="page-card__title">Clientes SaaS</h3>
        </header>
        <div class="page-card__body">
          <p class="page-card__lead">Vista consolidada de clinicas/clientes que usan el panel clinico de operacion diaria.</p>
          <ul class="page-card__list">
            <li>Estado por tenant y plan activo</li>
            <li>Uso de modulos en produccion</li>
            <li>Riesgos de renovacion y salud operativa</li>
          </ul>
        </div>
